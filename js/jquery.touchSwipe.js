...
!(function (factory) {
  ...
  function TouchSwipe(element, options) {
        ...
        if (
          ...
          return (
            ...
            touches
              ...
              : !1 !== options.preventDefaultEvents && jqEvent.preventDefault(),
            (distance = 0),
            (direction = null),
      ...
      return (
        ...
        didSwipeBackToCancel() || !validateSwipeDistance()
          ...
          : options.triggerOnTouchEnd ||
            (!1 === options.triggerOnTouchEnd && phase === PHASE_MOVE)
          ? (!1 !== options.preventDefaultEvents &&
              !1 !== jqEvent.cancelable &&
              jqEvent.preventDefault(),
            triggerHandler(event, (phase = PHASE_END)))
    ...
    function touchLeave(jqEvent) {
      var event = jqEvent.originalEvent ? jqEvent.originalEvent : jqEvent;
      options.triggerOnTouchLeave &&
        triggerHandler(event, (phase = getNextPhase(PHASE_END)));
    }
    ...
    function triggerHandler(event, phase) {
      ...
      return (
        ...
        phase === PHASE_END &&
          ((touches && touches.length) || touchCancel(event)),
        ret
      );
    }
    ...
    function inMultiFingerRelease() {
      ...
      previousTouchEndTime &&
        getTimeStamp() - previousTouchEndTime <=
          options.fingerReleaseThreshold &&
        (withinThreshold = !0);
