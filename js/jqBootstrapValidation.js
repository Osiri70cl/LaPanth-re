    ...
    defaults = {
              ...
              if (
                ...
                void 0 !== $this.attr("maxlength") &&
                  ...
                  void 0 !== $this.attr("type") &&
                    ...
                    ((message =
                      "Cette adresse email n'est pas valide\x3c!-- data-validator-validemail-message to override --\x3e"),
      ...
      builtInValidators: {
        ...
        required: {
          ...
          type: "required",
          message:
            "Veuillez remplir ce champs\x3c!-- data-validator-required-message to override --\x3e",
        },
        checkone: {
          name: "Checkone",
          type: "minchecked",
